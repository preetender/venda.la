...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      lazyDefault: __webpack_require__(/*! ../assets/default-lazy.png */ "./resources/js/assets/default-lazy.png"),
      defaultImage: __webpack_require__(/*! ../assets/default.png */ "./resources/js/assets/default.png")
    };
  },
  computed: {
    ...
    image: function image() {
      ...
      return function () {
        ...
        if (_this.images.length <= 0) {
          //
          if (size === 10) return _this.lazyDefault; //
