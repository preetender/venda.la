...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    product: function product() {
      return __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ../components/Product */ "./resources/js/components/Product.vue"));
    }
  },
  data: function data() {
    return {
      ...
      _c(
        ...
        [
          _c("v-progress-circular", {
            attrs: { indeterminate: "", color: "primary", size: "96" }
          })
        ],
        1
      ),
